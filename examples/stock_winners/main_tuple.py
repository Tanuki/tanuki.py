...
@tanuki.patch
def extract_stock_winners_best(input: str) -> tuple:
    """
...
def test_stock():
    ...
    assert extract_stock_winners_best(input_1) == ('Procter & Gamble', 'Winnebago Industries')
...
if __name__ == '__main__':
    ...
    output = extract_stock_winners_best(input)
    print(output)