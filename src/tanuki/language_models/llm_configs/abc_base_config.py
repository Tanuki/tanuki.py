...
class BaseModelConfig(abc.ABC, BaseModel):
    ...
    system_message : str = "You are a skillful and accurate language model, who applies a described function on input data. Make sure the function is applied accurately and correctly and the outputs follow the output type hints and are valid outputs given the output types."
    ...
    prompt_template_token_count : int = -1
